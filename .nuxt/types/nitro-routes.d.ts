...
declare module "nitropack/types" {
  ...
  interface InternalApi {
    '/css/**': {
      'default': Simplify<Serialize<Awaited<ReturnType<typeof import('../../server/routes/css/[...]').default>>>>
    }
    '/img/**': {
      'default': Simplify<Serialize<Awaited<ReturnType<typeof import('../../server/routes/img/[...]').default>>>>
    }
    '/js/**': {
      'default': Simplify<Serialize<Awaited<ReturnType<typeof import('../../server/routes/js/[...]').default>>>>
    }
    '/__nuxt_error': {
