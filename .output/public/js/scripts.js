(function ($) {
    ...
    // Note: winLoaded is set to true in the main $(window).on('load') handler at line ~10642
    // This ensures the page loader waits for ALL assets to load before completing
                    ...
                    for (i = 0; i < navTweens.length; i++) {
                        ...
                        if (navTweens[i]) {
                            ...
                            if (navTweens[i]?.parent) {
                                ...
                                // safely kill scrollTrigger if it exists
                                if (navTweens[i].parent.scrollTrigger) {
                                ...
                                if (navTweens[i].scrollTrigger) {
                                    navTweens[i].scrollTrigger.kill();
                                }
