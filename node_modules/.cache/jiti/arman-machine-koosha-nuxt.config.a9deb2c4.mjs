"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0; // Detect Vercel deployment environment
const isVercel = process.env.VERCEL === '1' || process.env.VERCEL === 'true';var _default = exports.default =
